...
/**
 * The InvokeGetCommand class.
 * 
 * <p>This class invoke get request.
 *
...
public class GetCommand extends HystrixCommand<String> {
    ...
    /**
     * The hystrix invoke get request.
     * 
     * @param restTemplate
     *            http rest client
     * @param serviceUrl
     ...
     */
    public GetCommand(RestTemplate restTemplate, String serviceUrl,
                ...
                .andThreadPoolPropertiesDefaults(
                    HystrixThreadPoolProperties.Setter()
                            .withCoreSize(reqConfigs.getThreadPoolCoreSize() > 0
                                    ...
                                    : appConfig.getIntegerProperty(
                                     "hystrix.threadpool.configGet.coreSize"))
