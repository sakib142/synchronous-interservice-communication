...
/**
 * The InvokePostCommand class.
 * 
 * <p>This class invoke post request.
 *
 ...
 *
 */
public class PostCommand extends HystrixCommand<String> {
    /**
    ...
    /**
     * The hystrix invoke post request.
     * 
     * @param restTemplate
     *            http rest client
     * @param serviceUrl
     ...
     */
    public PostCommand(RestTemplate restTemplate, String serviceUrl,
                ...
                .andThreadPoolPropertiesDefaults(
                    HystrixThreadPoolProperties.Setter()
                            .withCoreSize(reqConfigs.getThreadPoolCoreSize() > 0
                                    ...
                                    : appConfig.getIntegerProperty(
                                    "hystrix.threadpool.configPost.coreSize"))
