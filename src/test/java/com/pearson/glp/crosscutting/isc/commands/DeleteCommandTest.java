...
/**
 * The InvokeDeleteCommandTest class.
 * 
 *<p>This test class test delete request.
 *
...
public class DeleteCommandTest {
    /**
     * InvokeDeleteCommandTest instantiate.  
     */
    ...
    private final static Logger logger =
            LoggerFactory.getLogger(DeleteCommandTest.class);
    /**
     ...
     */
    @Test
    public void testWithHystrixPropertiesInitializationForDeleteMethod() {
        ...
        try {
            String result = new DeleteCommand(this.restTemplate,
    ...
    public void testFallbackScenerio() {
        ...
        try {
            String result = new DeleteCommand(this.restTemplate,
                    "http://localhost:8090/list", this.fallbackFunction,
                    new RequestConfiguration(5000, 7, 10), this.appConfig, headersMap)
                            .execute();
