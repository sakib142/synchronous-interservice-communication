...
/**
 * The InvokeGetCommandTest class.
 * 
 *<p>This test class test get request.
 *
...
public class GetCommandTest {
    /**
     * InvokeGetCommandTest instantiate.  
     */
    ...
    private final static Logger logger =
            LoggerFactory.getLogger(GetCommandTest.class);
    /**
     ...
     */
    @Test
    public void testWithHystrixPropertiesInitializationForGetMethod() {
        this.restTemplate = Mockito.mock(RestTemplate.class);
        HystrixRequestContext context =
                HystrixRequestContext.initializeContext();
        
        ResponseEntity<Object> myEntity =
                new ResponseEntity<>("Gaurav, Dinesh, Jeeevan", HttpStatus.ACCEPTED);
        ...
        try {
            String result = new GetCommand(this.restTemplate,
                    "http://localhost:8090/list", this.fallbackFunction,
                    new RequestConfiguration(7, 9), this.appConfig, headersMap).execute();
            Assert.assertEquals(result, "Gaurav, Dinesh, Jeeevan");
        } finally {
            context.shutdown();
        }
    }
    ...
    public void testFallbackScenerio() {
        ...
        try {
            String result = new GetCommand(this.restTemplate,
                    "http://localhost:8090/list", this.fallbackFunction,
                    new RequestConfiguration(5000, 7, 0), this.appConfig, headersMap)
                            .execute();
